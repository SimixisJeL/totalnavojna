        ...
        for (i = 0; i < 4; ++i) {
            ...
            this.addSlot(new Slot(container, slot++, 8 + i * 18, 16) {
                ...
                public boolean mayPlace(@NotNull ItemStack itemStack) {
                    return net.minecraft.world.entity.Mob.getEquipmentSlotForItem(itemStack) == equipmentslot;
                }
    ...
    public ItemStack quickMoveStack(@NotNull Player player, int index) {
        ...
        if (quickMovedSlot.hasItem()) {
            ...
            if (quickMovedSlot.container == this.container) {
                ...
                // Moving from player inventory into the soldier (hotbar + inventory slots)
